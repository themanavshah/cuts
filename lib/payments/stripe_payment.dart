...
// //   ).then((PaymentMethod zpaymentmethod) {
// //     print("zpm: " + zpaymentmethod.toString());
// //     return zpaymentmethod;
// //   }).catchError((e) {
// //     print("errorcnsl: " + e.toString());
// //   });
// //   startDirectCharge(paymentmethod);
// // }

// // Future<void> startDirectCharge(PaymentMethod rpaymentmethod) async {
// //   print("payment charge started");
// //   print(rpaymentmethod);

// //   var url = "http://localhost:3000/stripe_pay";

// //   Dio dio = new Dio();
// //   Response response = await dio
// //       .post("$url?amount=$amount&currency=USD&paym=${rpaymentmethod.id}");

// //   if (response.data != null) {
// //     print(response.data);
// //     final paymentIntent = jsonDecode(response.data);
...
// //         paymentMethodId: paymentIntent['paymentIntent']['payment_mehod'],
// //         clientSecret: paymentIntent['paymentIntent']['client_secret'],
// //       )).then((PaymentIntentResult paymentIntentResult) async {
// //         final PaymentIntentResultStatus = paymentIntentResult.status;
// //         if (PaymentIntentResultStatus == "succeeded") {
// //           print("payment done");
// //         }
// //       });
// //     }
...
//     "pk_test_51JFzWkSJFrMMx7cfl2SSroxTUBqem5xebftzHBcT1dNyTa9jdHkXd0AUrx8KSZ4fFnb2g7KvVJxdRPRUVT90Tnj600DpIWFqqI", //Your Publishable Key
//     stripeAccount:
//         "acct_1JFzWkSJFrMMx7cf", //Merchant Connected Account ID. It is the same ID set on server-side.
...
//         // }),
//         "$postCreateIntentURL?amount=$amount&currency=USD&paym=$paymentMethodId");
